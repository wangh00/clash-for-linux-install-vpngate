...
# VPNGate 二开功能使用独立状态、节点缓存与 Overlay，避免直接改写用户的
# mixin.yaml。runtime.yaml 由 base + mixin + vpngate overlay 三层合并得到。
CLASH_VPNGATE_DIR="${CLASH_RESOURCES_DIR}/vpngate"
CLASH_VPNGATE_STATE="${CLASH_VPNGATE_DIR}/state.yaml"
CLASH_VPNGATE_OVERLAY="${CLASH_VPNGATE_DIR}/overlay.yaml"
CLASH_VPNGATE_NODES_DIRECT="${CLASH_VPNGATE_DIR}/direct.yaml"
CLASH_VPNGATE_NODES_FRONT="${CLASH_VPNGATE_DIR}/front.yaml"
CLASH_VPNGATE_API_RAW="${CLASH_VPNGATE_DIR}/servers.csv"
CLASH_VPNGATE_LOG="${CLASH_VPNGATE_DIR}/update.log"
CLASH_VPNGATE_LOCK="${CLASH_VPNGATE_DIR}/vpngate.lock"
